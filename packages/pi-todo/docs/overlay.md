...
[`@schovest/pi-i18n`](https://www.npmjs.com/package/@schovest/pi-i18n)
...
`pi install npm:@schovest/pi-i18n` and restart the session. To add or
override a translation, drop a `locales/<code>.json` file mirroring `en.json` —
see the `@schovest/pi-i18n` README's "Contributing translations" section.
