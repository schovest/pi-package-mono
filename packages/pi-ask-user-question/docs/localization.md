...
[`@schovest/pi-pi`](https://www.npmjs.com/package/@schovest/pi-pi) and ran
...
`--locale` are registered by `@schovest/pi-i18n`, not by this package.
...
[`@schovest/pi-i18n`](https://www.npmjs.com/package/@schovest/pi-i18n) README,
