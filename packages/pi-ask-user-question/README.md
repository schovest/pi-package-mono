...
[![npm version](https://img.shields.io/npm/v/@schovest/pi-ask-user-question.svg)](https://www.npmjs.com/package/@schovest/pi-ask-user-question)
...
```sh
pi install npm:@schovest/pi-ask-user-question
```
...
- [`@schovest/pi-i18n`](https://www.npmjs.com/package/@schovest/pi-i18n) — optional; installing it renders the dialog chrome in your language and adds `/languages`.
- [`@schovest/pi-pi`](https://www.npmjs.com/package/@schovest/pi-pi) — the umbrella package whose workflow skills use `ask_user_question` as their developer checkpoint. `/rpiv-setup` offers to install this extension.
