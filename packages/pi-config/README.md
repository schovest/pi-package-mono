...
[![npm version](https://img.shields.io/npm/v/@schovest/pi-config.svg)](https://www.npmjs.com/package/@schovest/pi-config)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Shared JSON config I/O for the `@schovest/pi-*` packages — XDG-aware path resolution, loads
...
| Package | Uses |
| --- | --- |
| [`rpiv-pi`](https://www.npmjs.com/package/@schovest/pi-pi) | Path resolution, model-key codec, schema validation for model config |
| [`rpiv-advisor`](https://www.npmjs.com/package/@schovest/pi-advisor) | Model-key codec, guidance fields, config load/save |
| [`rpiv-web-tools`](https://www.npmjs.com/package/@schovest/pi-web-tools) | Provider config load/save, guidance schema and validation |
...
| [`rpiv-voice`](https://www.npmjs.com/package/@schovest/pi-voice) | Config load/save |
| [`rpiv-i18n`](https://www.npmjs.com/package/@schovest/pi-i18n) | Config load/save |
| [`rpiv-todo`](https://www.npmjs.com/package/@schovest/pi-todo) | Config load, guidance fields |
| [`rpiv-ask-user-question`](https://www.npmjs.com/package/@schovest/pi-ask-user-question) | Config load, guidance fields |
| [`rpiv-warp`](https://www.npmjs.com/package/@schovest/pi-warp) | Config load |
| [`rpiv-workflow`](https://www.npmjs.com/package/@schovest/pi-workflow) | Path resolution |
