import { applyLocale, registerStrings } from "@schovest/pi-i18n";
import { beforeEach, describe, expect, it } from "vitest";
import { I18N_NAMESPACE, formatStatusLabel, t } from "./i18n-bridge.js";
...
describe("i18n-bridge", () => {
  ...
  it("namespace constant is the canonical package name", () => {
    expect(I18N_NAMESPACE).toBe("@schovest/pi-todo");
  });
});
