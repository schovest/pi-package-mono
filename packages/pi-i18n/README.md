...
[![npm version](https://img.shields.io/npm/v/@schovest/pi-i18n.svg)](https://www.npmjs.com/package/@schovest/pi-i18n)
...
```sh
pi install npm:@schovest/pi-i18n
```
...
To localize your own extension, add `@schovest/pi-i18n` to your
`peerDependencies` (marked optional), then at extension load:

```ts
import { scope } from "@schovest/pi-i18n";
import { registerLocalesFromDir } from "@schovest/pi-i18n/loader";
...
- [SDK reference](https://github.com/juicesharp/rpiv-mono/blob/main/packages/rpiv-i18n/docs/sdk-reference.md)
  — every export from `@schovest/pi-i18n` and `/loader`, the fallback
...
- [@schovest/pi-todo](https://www.npmjs.com/package/@schovest/pi-todo),
  [@schovest/pi-ask-user-question](https://www.npmjs.com/package/@schovest/pi-ask-user-question),
  and [@schovest/pi-voice](https://www.npmjs.com/package/@schovest/pi-voice)
