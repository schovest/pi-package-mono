 ...
 *   - bridge module (this directory) — `await import("@schovest/pi-i18n")`
...
const SDK_SPECIFIER = "@schovest/pi-i18n";

// The specifier may carry an optional subpath (e.g. `/loader`) — the entry
// point uses `@schovest/pi-i18n/loader` to avoid pulling the UI module
// into the load graph; the bridge uses the bare `@schovest/pi-i18n`
