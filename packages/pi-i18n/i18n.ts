...
import { configPath, loadJsonConfigWithLegacyFallback, saveJsonConfig } from "@schovest/pi-config";
...
// a consumer's `node_modules/@schovest/pi-i18n` import — Pi's TS loader
