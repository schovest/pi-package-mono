 ...
 * SDK is actually installed. If `@schovest/pi-i18n` is missing (standalone
 ...
 * `SUPPORTED_LOCALES` from the SDK. See `@schovest/pi-i18n` README →
...
// Dynamic import keeps `@schovest/pi-i18n` a soft optional peer: when the
...
try {
  const sdk = (await import("@schovest/pi-i18n/loader")) as I18nLoader;
